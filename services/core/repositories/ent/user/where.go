...
// HasPcapworkspaces applies the HasEdge predicate on the "pcapworkspaces" edge.
func HasPcapworkspaces() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasPcapworkspacesWith applies the HasEdge predicate on the "pcapworkspaces" edge with a given conditions (other predicates).
func HasPcapworkspacesWith(preds ...predicate.PcapWorkspace) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newPcapworkspacesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
