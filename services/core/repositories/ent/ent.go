...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			analyzercomponent.Table: analyzercomponent.ValidColumn,
			analyzerpayload.Table:   analyzerpayload.ValidColumn,
			cartsession.Table:       cartsession.ValidColumn,
			filter.Table:            filter.ValidColumn,
			matchedpacket.Table:     matchedpacket.ValidColumn,
			packet.Table:            packet.ValidColumn,
			pcapworkspace.Table:     pcapworkspace.ValidColumn,
			plugin.Table:            plugin.ValidColumn,
			service.Table:           service.ValidColumn,
			session.Table:           session.ValidColumn,
			sessionfilter.Table:     sessionfilter.ValidColumn,
